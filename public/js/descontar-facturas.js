    ...
    response.json().then((data)=>{
        if(data.error){
            ...
            return console.log(data.error)
                ...
                var row, cell;
                var titles = $('<th>Nombre del Comprador</th><th>RFC</th><th>Numero de Factura</th><th>Folio Fiscal</th><th>Fecha de Factura</th><th>Fecha de Vencimiento</th><th>Moneda</th><th> Valor de la Factura</th><th>IVA</th><th>Trade Date</th><th>Aforo</th>'
